...
import { renderToString } from 'file://C:/Code/Muskelmekanikeren/frontend/node_modules/vue/server-renderer/index.mjs';
import { propsToString, renderSSRHead } from 'file://C:/Code/Muskelmekanikeren/frontend/node_modules/@unhead/ssr/dist/index.mjs';
import { createServerHead as createServerHead$1, CapoPlugin } from 'file://C:/Code/Muskelmekanikeren/frontend/node_modules/unhead/dist/index.mjs';
import { klona } from 'file://C:/Code/Muskelmekanikeren/frontend/node_modules/klona/dist/index.mjs';
import defu, { defuFn } from 'file://C:/Code/Muskelmekanikeren/frontend/node_modules/defu/dist/defu.mjs';
import { snakeCase } from 'file://C:/Code/Muskelmekanikeren/frontend/node_modules/scule/dist/index.mjs';
import { createHooks } from 'file://C:/Code/Muskelmekanikeren/frontend/node_modules/hookable/dist/index.mjs';
import { createFetch as createFetch$1, Headers as Headers$1 } from 'file://C:/Code/Muskelmekanikeren/frontend/node_modules/ofetch/dist/node.mjs';
import { createCall, createFetch } from 'file://C:/Code/Muskelmekanikeren/frontend/node_modules/unenv/runtime/fetch/index.mjs';
...
import { toRouteMatcher, createRouter } from 'file://C:/Code/Muskelmekanikeren/frontend/node_modules/radix3/dist/index.mjs';
import { defineHeadPlugin } from 'file://C:/Code/Muskelmekanikeren/frontend/node_modules/@unhead/shared/dist/index.mjs';
...
const rootDir = "C:/Code/Muskelmekanikeren/frontend";
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"C:\\Code\\Muskelmekanikeren\\frontend","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"C:\\Code\\Muskelmekanikeren\\frontend\\server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"C:\\Code\\Muskelmekanikeren\\frontend\\.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"C:\\Code\\Muskelmekanikeren\\frontend\\.nuxt\\cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"C:\\Code\\Muskelmekanikeren\\frontend\\.data\\kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const getClientManifest = () => import('file://C:/Code/Muskelmekanikeren/frontend/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file://C:/Code/Muskelmekanikeren/frontend/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
